...
**How to apply:** Run API code generation and library typechecking together; resolve the generated export collision without changing the runtime endpoint contract.
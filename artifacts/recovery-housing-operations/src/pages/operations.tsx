...
import { confirmResidentImport, downloadResidentTemplate, exportReport, get, getReportPreview, previewResidentImport, reportFilename, reportTypes, type ReportFormat, type ReportType } from '@/lib/api';
...
function LegacyReports({ data, isAdministrator }: { data?: any; isAdministrator: boolean }) {
  const [reportType, setReportType] = useState<ReportType>('occupancy');
  const [format, setFormat] = useState<ReportFormat>('csv');
